...
A collection of scripts and tools for constructing a docker image to build dxvk, vkd3d-proton, dxvk-sarek, d7vk, dxvk-ags, dxvk-nvapi, dxvk-tests, d3d8to9, d3d9to8, nvcuda, nvidia-libs, apitrace, dsoal and even wine tests and libraries. Are you on Debian & derivatives or some other obscure distro and are tired of shuffling MinGW versions? Forget about your worries and build dxvk, vkd3d-proton, dxvk-sarek, d7vk, dxvk-ags, dxvk-nvapi, dxvk-tests, d3d8to9, d3d9to8, nvcuda, nvidia-libs, apitrace, dsoal and wine tests and libraries using an Arch based docker container.
...
* Finally, you're now ready to launch the build container and enjoy your builds! Use:
    ...
    Where `<repo_name>` can be either dxvk, vkd3d-proton, dxvk-sarek, d7vk, dxvk-ags, dxvk-nvapi, dxvk-tests, d3d8to9, d3d9to8, nvcuda, nvidia-libs, apitrace or dsoal. You can optionally also specify a `<build_name>`, otherwise it will default to `devel`.
  
    Run the above whenever you need to build/rebuild dxvk, vkd3d-proton, dxvk-sarek, d7vk, dxvk-ags, dxvk-nvapi, dxvk-tests, d3d8to9, d3d9to8, nvcuda, nvidia-libs, apitrace or dsoal. Note that the scripts will delete the previously compiled binaries if you use the same parameters. Back up any folders in the `output` directory if you want to keep older versions around.
